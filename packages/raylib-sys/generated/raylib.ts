...
const shimSymbols = {
	...
	kreb_get_Image_width: { args: ['ptr'], returns: 'i32' },
	kreb_get_Image_height: { args: ['ptr'], returns: 'i32' },
	kreb_get_Image_mipmaps: { args: ['ptr'], returns: 'i32' },
	kreb_get_Image_format: { args: ['ptr'], returns: 'i32' },
	kreb_get_Texture_id: { args: ['ptr'], returns: 'u32' },
	kreb_get_Texture_width: { args: ['ptr'], returns: 'i32' },
	kreb_get_Texture_height: { args: ['ptr'], returns: 'i32' },
	kreb_get_Texture_mipmaps: { args: ['ptr'], returns: 'i32' },
	kreb_get_Texture_format: { args: ['ptr'], returns: 'i32' },
	kreb_get_RenderTexture_id: { args: ['ptr'], returns: 'u32' },
	kreb_ref_RenderTexture_texture: { args: ['ptr'], returns: 'ptr' },
	kreb_ref_RenderTexture_depth: { args: ['ptr'], returns: 'ptr' },
	kreb_get_NPatchInfo_source: { args: ['ptr', 'ptr'], returns: 'void' },
	kreb_get_NPatchInfo_left: { args: ['ptr'], returns: 'i32' },
	kreb_get_NPatchInfo_top: { args: ['ptr'], returns: 'i32' },
	kreb_get_NPatchInfo_right: { args: ['ptr'], returns: 'i32' },
	kreb_get_NPatchInfo_bottom: { args: ['ptr'], returns: 'i32' },
	kreb_get_NPatchInfo_layout: { args: ['ptr'], returns: 'i32' },
	kreb_get_GlyphInfo_value: { args: ['ptr'], returns: 'i32' },
	kreb_get_GlyphInfo_offsetX: { args: ['ptr'], returns: 'i32' },
	kreb_get_GlyphInfo_offsetY: { args: ['ptr'], returns: 'i32' },
	kreb_get_GlyphInfo_advanceX: { args: ['ptr'], returns: 'i32' },
	kreb_ref_GlyphInfo_image: { args: ['ptr'], returns: 'ptr' },
	kreb_get_Font_baseSize: { args: ['ptr'], returns: 'i32' },
	kreb_get_Font_glyphCount: { args: ['ptr'], returns: 'i32' },
	kreb_get_Font_glyphPadding: { args: ['ptr'], returns: 'i32' },
	kreb_ref_Font_texture: { args: ['ptr'], returns: 'ptr' },
	kreb_get_Camera3D_position: { args: ['ptr', 'ptr'], returns: 'void' },
	kreb_get_Camera3D_target: { args: ['ptr', 'ptr'], returns: 'void' },
	kreb_get_Camera3D_up: { args: ['ptr', 'ptr'], returns: 'void' },
	kreb_get_Camera3D_fovy: { args: ['ptr'], returns: 'f32' },
	kreb_get_Camera3D_projection: { args: ['ptr'], returns: 'i32' },
	kreb_get_Camera2D_offset: { args: ['ptr', 'ptr'], returns: 'void' },
	kreb_get_Camera2D_target: { args: ['ptr', 'ptr'], returns: 'void' },
	kreb_get_Camera2D_rotation: { args: ['ptr'], returns: 'f32' },
	kreb_get_Camera2D_zoom: { args: ['ptr'], returns: 'f32' },
	kreb_get_Mesh_vertexCount: { args: ['ptr'], returns: 'i32' },
	kreb_get_Mesh_triangleCount: { args: ['ptr'], returns: 'i32' },
	kreb_get_Mesh_boneCount: { args: ['ptr'], returns: 'i32' },
	kreb_get_Mesh_vaoId: { args: ['ptr'], returns: 'u32' },
	kreb_get_Shader_id: { args: ['ptr'], returns: 'u32' },
	kreb_ref_MaterialMap_texture: { args: ['ptr'], returns: 'ptr' },
	kreb_get_MaterialMap_color: { args: ['ptr'], returns: 'u32' },
	kreb_get_MaterialMap_value: { args: ['ptr'], returns: 'f32' },
	kreb_ref_Material_shader: { args: ['ptr'], returns: 'ptr' },
	kreb_get_BoneInfo_parent: { args: ['ptr'], returns: 'i32' },
	kreb_get_ModelSkeleton_boneCount: { args: ['ptr'], returns: 'i32' },
	kreb_get_Model_transform: { args: ['ptr', 'ptr'], returns: 'void' },
	kreb_set_Model_transform: { args: ['ptr', 'ptr'], returns: 'void' },
	kreb_get_Model_meshCount: { args: ['ptr'], returns: 'i32' },
	kreb_get_Model_materialCount: { args: ['ptr'], returns: 'i32' },
	kreb_ref_Model_skeleton: { args: ['ptr'], returns: 'ptr' },
	kreb_get_ModelAnimation_boneCount: { args: ['ptr'], returns: 'i32' },
	kreb_get_ModelAnimation_keyframeCount: { args: ['ptr'], returns: 'i32' },
	kreb_get_Wave_frameCount: { args: ['ptr'], returns: 'u32' },
	kreb_get_Wave_sampleRate: { args: ['ptr'], returns: 'u32' },
	kreb_get_Wave_sampleSize: { args: ['ptr'], returns: 'u32' },
	kreb_get_Wave_channels: { args: ['ptr'], returns: 'u32' },
	kreb_get_AudioStream_sampleRate: { args: ['ptr'], returns: 'u32' },
	kreb_get_AudioStream_sampleSize: { args: ['ptr'], returns: 'u32' },
	kreb_get_AudioStream_channels: { args: ['ptr'], returns: 'u32' },
	kreb_ref_Sound_stream: { args: ['ptr'], returns: 'ptr' },
	kreb_get_Sound_frameCount: { args: ['ptr'], returns: 'u32' },
	kreb_ref_Music_stream: { args: ['ptr'], returns: 'ptr' },
	kreb_get_Music_frameCount: { args: ['ptr'], returns: 'u32' },
	kreb_get_Music_looping: { args: ['ptr'], returns: 'i32' },
	kreb_get_Music_ctxType: { args: ['ptr'], returns: 'i32' },
	kreb_get_VrDeviceInfo_hResolution: { args: ['ptr'], returns: 'i32' },
	kreb_get_VrDeviceInfo_vResolution: { args: ['ptr'], returns: 'i32' },
	kreb_get_VrDeviceInfo_hScreenSize: { args: ['ptr'], returns: 'f32' },
	kreb_get_VrDeviceInfo_vScreenSize: { args: ['ptr'], returns: 'f32' },
	kreb_get_VrDeviceInfo_eyeToScreenDistance: { args: ['ptr'], returns: 'f32' },
	kreb_get_VrDeviceInfo_lensSeparationDistance: { args: ['ptr'], returns: 'f32' },
	kreb_get_VrDeviceInfo_interpupillaryDistance: { args: ['ptr'], returns: 'f32' },
	kreb_get_FilePathList_count: { args: ['ptr'], returns: 'u32' },
	kreb_get_AutomationEvent_frame: { args: ['ptr'], returns: 'u32' },
	kreb_get_AutomationEvent_type: { args: ['ptr'], returns: 'u32' },
	kreb_get_AutomationEventList_capacity: { args: ['ptr'], returns: 'u32' },
	kreb_get_AutomationEventList_count: { args: ['ptr'], returns: 'u32' },
	kreb_write_Texture: { args: ['ptr', 'ptr'], returns: 'void' },
	kreb_write_NPatchInfo: { args: ['ptr', 'ptr'], returns: 'void' },
	kreb_write_Camera3D: { args: ['ptr', 'ptr'], returns: 'void' },
	kreb_write_Camera2D: { args: ['ptr', 'ptr'], returns: 'void' },
